...
|---------------------------------|--|
| <img width="2300" height="800" alt="image" src="https://github.com/user-attachments/assets/271eabf0-2ead-450b-b8b7-0b37e7866d90" /> |Challenges at The Look eCommerce, are common among companies experiencies rapid growth like the The Look.<br>There are two functional areas with clear opportunities for improvement: Marketing and Operations.<br>Marketing:<br>Should prioritize two initiatives. First, enhancing the platform’s front end and user experience to encourage upselling and cross-selling—this would help increase the average selling price and the number of items per cart. Second, implementing a customer loyalty program to reward repeat purchases and strengthen retention.<br>Operations:<br>There’s a notable backlog of orders still in preparation, which increases the risk of cancellations and returns. Additionally, there´s room for deliveries taking longer than average to improve logistics and delivery performance. Why this matters:<br>If these issues aren’t addressed, in the short term we company will face financial issues due to capital tied up in unfulfilled orders. High return rates and poor delivery experiences could also lead to customer churn, especially if competitors offer better UX and faster delivery. This would negatively impact our revenue growth and long-term sustainability.
