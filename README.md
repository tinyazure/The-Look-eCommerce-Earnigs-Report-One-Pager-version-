...
[Final Presentation & Recommentations ](#final-presentation)

## Overview
theLook is a fictional eCommerce clothing platform created by the Looker/Google team hosted on Google Cloud (uses Synthetic eCommerce and Digital Marketing data). The project will assume that theLook operates as a publicly traded company and the operations and analytics team are chalenged on creating a SEC-compliant earnings report for Q2 2025 and also propose some insights. For this matter SQL will be used to query key performance indicators (KPIs) against the dataset and prepare an investor-facing earnings report for theLook and business advising. As a industry benchmark the report will use Mercado Libre’s finantial reports.  <h6>***Note: Public companies are required by the SEC to disclose detailed financial statements and earnings reports each quarter for transparency with investors and the public.***</div>
...
2. Q2 2025 Number of Unique Buyers:    
   * 11516
   * Insights:<br>
       -Low puchasing frequencies of active customer during the period and also low quantities of items inclued in the cart for each order.4 purchases is the maximun number of time and active customer<br>
       -Only 104 active customers from a total of 11.5k (less than 1%) made purchases between 3 and 4 times.   
...
|---------------------------------|--|
| <img width="2300" height="800" alt="image" src="https://github.com/user-attachments/assets/271eabf0-2ead-450b-b8b7-0b37e7866d90" /> |Challenges at The Look eCommerce, are common among companies experiencies rapid growth like the The Look.<br>There are two functional areas with clear opportunities for improvement: Marketing and Operations.<br><br>Marketing:<br>Should prioritize two initiatives. First, enhancing the platform’s front end and user experience to encourage upselling and cross-selling—this would help increase the average selling price and the number of items per cart. Second, implementing a customer loyalty program to reward repeat purchases and strengthen retention.<br><br>Operations:<br>There’s a notable backlog of orders still in preparation, which increases the risk of cancellations and returns. Additionally, there´s room for deliveries taking longer than average to improve logistics and delivery performance.<br><br>Why this matters:<br>If these issues aren’t addressed, in the short term we company will face financial issues (over tarding) due to capital tied up in unfulfilled orders. High return rates and poor delivery experiences could also lead to customer churn, especially if competitors offer better UX and faster delivery. This would negatively impact our revenue growth and long-term sustainability.
